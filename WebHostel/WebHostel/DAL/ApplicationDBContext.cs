...
namespace WebHostel.DAL
{
    ...
    public class ApplicationDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<orders_history>().ToTable("orders_history").HasKey(oh => oh.id);
            ...
            modelBuilder.Entity<Products>().ToTable("Products").HasKey(h => h.id);
